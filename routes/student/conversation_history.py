...
from studentProfileDetails.dbutils.chat_session_manager import ChatSessionManager
...
async def get_conversation_history(
    ...
    try:
        ...
        from studentProfileDetails.dbutils.database import DatabaseConnection
