...
MONGODB_URI = "mongodb+srv://abhishek1233445:A0t24VdRZzQ0eJSa@cluster0.fgmkf.mongodb.net/10th?retryWrites=true&w=majority"

# Connect to the Atlas cluster
client = MongoClient(MONGODB_URI)

# Select the database
db = client["8th"]  # database name from your URI

# Update Science collection
db.Arts.update_many(
    {},
    {"$set": {"agent_metadata.description": "This agent explains art concepts in a clear and simple way.It uses examples to help students understand creativity and expression.Students can learn comfortably while exploring ideas."}}
)

# Update Math collection
db.Socity.update_many(
    {},
    {"$set": {"agent_metadata.description": "This agent teaches social concepts in an easy and understandable manner.It uses simple examples to explain how society works.Students can grasp ideas clearly without confusion."}}
)
